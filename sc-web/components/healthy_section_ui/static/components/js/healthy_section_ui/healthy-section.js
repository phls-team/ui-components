     ...
     /* $('#search-btn').click(function () {
        ...
        switch (selected) {
            case "amino_acids":
              ...
              break;
              case "growth_hormone":
               self._findSubject(10);
              break;
              case "isotonic":
               self._findSubject(11);
              break;
              case "meal_replacement":
               self._findSubject(12);
              break;
              case "nitrogen_oxide_doner":
               self._findSubject(13);
              break;
              case "phosphatidylserine":
               self._findSubject(14);
              break;
              case "testosterone":
               self._findSubject(15);
              break;
              case "vitamin_complexes":
               self._findSubject(16);
              break;
              case "hondroprotector":
               self._findSubject(17);
              break;
        }
            });
*/
