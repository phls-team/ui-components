...
healthySection.PaintPanel.prototype = {
    ...
    _initMarkup: function (containerId) {
      ...
      var self = this;
      container.append('<label for="introduction" id="interface"><u><h2>Добро пожаловать в интерефейс посвященному Здоровому образу жизни</h2></u></label>');
      container.append('<label for="sport_nutrition" id="sport_nutrition"><b><a href="https://ru.wikipedia.org/wiki/Спортивное_питание">Спортивное питание</a><b></label>');
...
/*
      ...
      +'</option>'
      +'</select>');
	container.append('<button id="choose-sport-nutrition" type="button">Показать</button>');
 $('#choose-sport-nutrition').click(function () {
...
*/
      ...
      //finish disease
      container.append('<label for="diseases" id="epidemic-diseases-label"><b><a href="https://ru.wikipedia.org/wiki/Список_эпидемий_и_пандемий">Болезни-эпидемии</a><b></label>');
